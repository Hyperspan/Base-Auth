...
namespace Base.Database.Migrations
{
    ...
    [Migration("20231016203545_Auth-Init")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auth.Domain.DatabaseModals.ApplicationRole<System.Guid>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Auth.Domain.DatabaseModals.ApplicationUser<System.Guid>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Auth.Domain.DatabaseModals.ApplicationRole<System.Guid>", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Auth.Domain.DatabaseModals.ApplicationUser<System.Guid>", null)
                        .WithMany()
